...
class Actor(nn.Module):
    """Gaussian policy for Pendulum continuous actions."""
...
class PPOAgent:
    """PPO-Clip agent for Pendulum-v1."""
...
def parse_args():
    ...
    parser.add_argument("--model-path", type=str, default="LAB7_314553032_task2_ppo_pendulum_trainbest.pt")
    parser.add_argument("--eval-model-path", type=str, default="LAB7_314553032_task2_ppo_pendulum.pt")
    ...
    parser.add_argument("--video-folder", type=str, default="videos/ppo_pendulum")
