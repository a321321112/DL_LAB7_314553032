...
| Done | Implement A2C update step | Pending current commit | `python3 -m py_compile a2c_pendulum.py` passed; runtime smoke blocked | Completed TD target, actor loss, critic loss, entropy. Runtime test blocked because local Python has no `torch`. |
