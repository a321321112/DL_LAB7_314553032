...
```txt
LAB7_314553032_task1_a2c_pendulum_trainbest_logstd.pt   # 單一 training episode best_return，診斷用
LAB7_314553032_task1_a2c_pendulum_evalbest_logstd.pt    # seeds 0-19 mean reward 最佳，評分優先用
```
...
5. 優先使用 `LAB7_314553032_task1_a2c_pendulum_evalbest_logstd.pt` 做最終 evaluation。
...
- [ ] 已產生 `LAB7_314553032_task1_a2c_pendulum_trainbest_logstd.pt`。
- [ ] 已產生 `LAB7_314553032_task1_a2c_pendulum_evalbest_logstd.pt`。
